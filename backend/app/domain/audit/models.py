...
class AuditEventType(StrEnum):
    ...
    CHANGE_POLICY_ASSESSED = "CHANGE_POLICY_ASSESSED"
    CHANGE_APPROVAL_REQUESTED = "CHANGE_APPROVAL_REQUESTED"
    ...
    GITOPS_RECONCILIATION_STARTED = "GITOPS_RECONCILIATION_STARTED"
    GITOPS_SYNCED = "GITOPS_SYNCED"
    GITOPS_HEALTHY = "GITOPS_HEALTHY"
    CHANGE_VERIFICATION_FAILED = "CHANGE_VERIFICATION_FAILED"
    CHANGE_VERIFIED = "CHANGE_VERIFIED"
    CHANGE_RESOLVED = "CHANGE_RESOLVED"
    CHANGE_RECONCILIATION_REQUIRED = "CHANGE_RECONCILIATION_REQUIRED"
