export const queryKeys = {
  ...
  change: (changeId: string | undefined) => ["change", changeId] as const,
  changeTimeline: (changeId: string | undefined) => ["change-timeline", changeId] as const,
  changePreview: (changeId: string | undefined) => ["change-preview", changeId] as const,
